...
var showAlert = function showAlert(type, message) {
  ...
  document.body.insertAdjacentHTML('afterbegin', html); // hide alert after 5 secs
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmljaGVib255IiwiYSI6ImNrdGJnNDY3ZDF2eWsycW84dzc5OGRhdzcifQ.C9mqGAaakSDpk8CU08-1eA';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, "  : ").concat(location.description, "<p>")).addTo(map); // Extend mark bounds to include current location
...
var updateProfile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, object) {
    var endPoint, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            endPoint = type === 'password' ? 'http://127.0.0.1:4000/api/v1/users/updatePassword' : 'http://127.0.0.1:4000/api/v1/users/updateMe';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
...
var stripe = Stripe('pk_test_51JaKS3AgVL7m3xndBBuDdNoheTisB6yZhrnhbeUo83PE1FKh31eMw6JrfDbAnSWoPT1NrJBoI5E60LDhOFSNe4kd00vhEs3LFd');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:4000/api/v1/bookings/checkout-session/".concat(tourId)
            });
...
if (userForm) {
  userForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateProfile)('data', formData);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              _context.next = 3;
              return (0, _updateSettings.updateProfile)('password', {
